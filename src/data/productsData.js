...
export const FITTING_CATEGORIES = [
  {
    ...
    name: "Flooring",
    tagline:
      "Turnkey Supply & Installation of Premium Commercial & Residential Flooring",
    description:
      "We supply and professionally install SPC, Hardwood, Vinyl, Epoxy, Gym Rubber, Wall to Wall Carpet, Center Piece Rugs, PVC Coil Mats, and Carpet Tiles across Pakistan.",
    items: [
      {
        id: "spc-flooring",
        name: "SPC Flooring",
        badge: "Popular Choice",
        target: "Houses & Offices",
      },
      {
        id: "wooden-flooring",
        name: "Wooden Flooring",
        badge: "Luxury Finish",
        target: "Villas & Lounges",
      },
      {
        id: "vinyl-flooring",
        name: "Vinyl Flooring",
      ...
      },
      {
        ...
        name: "Epoxy Flooring",
        badge: "High Gloss",
        target: "Showrooms & Plazas",
      },
      {
        id: "wall-to-wall-carpet",
        name: "Wall to Wall Carpet",
        badge: "Soft Acoustic",
        target: "Hotels & Bedrooms",
      },
      {
        id: "center-piece-rugs",
        name: "Center Piece Rugs",
        badge: "Luxury Accent",
        target: "Drawing & TV Lounges",
      },
      {
        id: "kids-eva-flooring",
        name: "Kids EVA Flooring",
        badge: "Soft Foam",
        target: "Schools & Daycares",
      },
      {
        id: "sports-flooring",
        name: "Sports Flooring",
        badge: "FIBA Standard",
        target: "Indoor Arenas",
      },
      {
        id: "gym-flooring",
        name: "Gym Flooring",
        badge: "Heavy Impact",
        target: "Commercial Gyms",
      },
      {
        id: "pvc-coil-mats",
        name: "PVC Coil Mats",
        badge: "Dust Trap",
        target: "Building Entrances",
      },
      {
        id: "carpet-tiles",
        name: "Carpet Tiles",
      ...
      },
      {
        ...
        badge: "All-Season Green",
        target: "Lawns & Terraces",
      },
    ],
  },
  {
    ...
    description:
      "Precision window measurement, cassette mounting, and remote motor automation for Roller, Vertical, Wooden, Zebra, PVC Strip Curtains, and Custom Printed Blinds.",
    items: [
      {
        id: "roller-blinds",
        name: "Roller Blinds",
        badge: "Thermal Blackout",
        target: "Bedrooms & Offices",
      },
      {
        id: "vertical-blinds",
        name: "Vertical Blinds",
        badge: "Light Control",
        target: "Commercial Windows",
      },
      {
        id: "wooden-blinds",
        name: "Wooden Blinds",
        badge: "Natural Wood",
        target: "Executive Suites",
      },
      {
        id: "bamboo-chick-blinds",
        name: "Bamboo Chick Blinds",
        badge: "Eco Friendly",
        target: "Patios & Penthouses",
      },
      {
        id: "zebra-blinds",
        name: "Zebra Blinds",
      ...
      },
      {
        ...
        target: "Cold Storage & Warehouses",
      },
      {
        id: "verman-blinds",
        name: "Verman Blinds",
        badge: "Shangri-La Sheer",
        target: "Luxury Lounges",
      },
      {
        id: "customise-printed-design-blind",
        name: "Customise Printed Design Blind",
        badge: "Custom Art",
        target: "Kids & Branding",
      },
      {
        id: "curtains",
        name: "Curtains",
        badge: "Luxury Drapes",
        target: "Master Bedrooms",
      },
    ],
  },
  {
    ...
    description:
      "Transform interior walls with imported Korean 3D wallpapers, WPC vertical fluted slats, damp-proof PVC panels, canvas wall art, and plaster mouldings.",
    items: [
      {
        id: "wallpaper-all-generation",
        name: "Wallpaper All Generation",
        badge: "3D Texture",
        target: "Bedrooms & Feature Walls",
      },
      {
        id: "customise-design-canvas",
        name: "Customise Design Canvas",
        badge: "Bespoke Wall Art",
        target: "Drawing Rooms",
      },
      {
        id: "pvc-panel",
        name: "PVC Panel",
        badge: "Damp Proof",
        target: "Shops & Basements",
      },
      {
        id: "fluted-panels",
        name: "Fluted Panels",
        badge: "Media Wall Trend",
        target: "TV Lounges",
      },
      {
        id: "wall-texture",
        name: "Wall Texture",
        badge: "Tactile Plaster",
        target: "Living Spaces",
      },
      {
        id: "wall-moulding",
        name: "Wall Moulding",
        badge: "Classic European",
        target: "Dining & Corridors",
      },
    ],
  },
  {
    ...
    description:
      "Turnkey custom furniture design and craftmanship for corporate executive offices, boardrooms, luxury residential villas, and lounges.",
    items: [
      {
        id: "commercial-furniture",
        name: "Commercial Furniture",
        badge: "Executive Office",
        target: "Corporate Offices & Boardrooms",
      },
      {
        id: "residential-furniture",
        name: "Residential Furniture",
        badge: "Luxury Villa",
        target: "Master Bedrooms & Living Lounges",
      },
    ],
  },
  {
    ...
    description:
      "High-gloss acrylic, UV coated, and solid wood modular kitchen design and turnkey site installation.",
    isSingle: true,
    ...
    items: [
      {
        ...
        badge: "Luxury Cabinetry",
        target: "Villas & Apartments",
      },
    ],
  },
  {
    ...
    description:
      "Designer false ceiling installation with integrated warm cove lighting, gypsum board framing, and acoustic sound dampening tiles.",
    isSingle: true,
  ...
  },
  {
    ...
    description:
      "Weatherproof fiber glass car parking canopies, outdoor patio shades, and tensile fabric structures for houses and commercial plazas.",
    isSingle: true,
...
export const SOLUTIONS_DATA = {
  ...
  "spc-flooring": {
    ...
    description:
      "We supply and professionally fit SPC (Stone Plastic Composite) rigid core wood flooring for bedrooms, drawing rooms, TV lounges, and kitchens.",
  ...
  "wooden-flooring": {
    ...
    description:
      "Introduce natural wood luxury to executive suites and drawing rooms. We install high-density engineered oak hardwood with wax-sealed joints.",
    ...
    features: [
      ...
      "Herringbone & Straight Plank Assembly",
  ...
  "vinyl-flooring": {
    ...
    description:
      "Professional PVC vinyl flooring installation for residential apartments and rental properties.",
  ...
  "epoxy-flooring": {
    ...
    description:
      "Liquid-applied self-leveling 3D metallic epoxy flooring pour for car showrooms and luxury boutiques.",
  ...
  "wall-to-wall-carpet": {
    ...
    description:
      "Turnkey wall-to-wall plush carpet installation with high-density foam underlayment pad.",
    ...
    features: [
      "Ultra Soft Underfoot Cushioning",
      "High Sound Dampening Noise Insulation",
    ],
  ...
  "center-piece-rugs": {
    ...
    description:
      "Exquisite hand-tufted designer center piece rugs in modern geometric and traditional textures.",
    ...
    features: [
      "Bespoke Hand-Tufted Wool & Silk Yarns",
      "Non-Slip Rubberized Backing Finish",
    ],
  ...
  "kids-eva-flooring": {
    ...
    description:
      "Soft cushioned EVA foam puzzle tile fitting for nursery classrooms and play areas.",
  ...
  "sports-flooring": {
    ...
    description:
      "Elastic polyurethane sports flooring system pour for basketball courts and badminton arenas.",
    image: "/images/products/img_25.webp",
    gallery: ["/images/products/img_25.webp", "/images/products/img_26.webp"],
  ...
  "gym-flooring": {
    ...
    categoryName: "Flooring",
    subtitle:
      "Heavy Duty Weight Drop Protection for Commercial Gyms & Crossfit",
    description:
      "High-density vulcanized rubber tiles for heavy free-weight zones and personal training studios.",
  ...
  "pvc-coil-mats": {
    ...
    description:
      "Heavy duty PVC vinyl coil cushion matting for corporate plaza entrances and hotel foyers.",
  ...
  "carpet-tiles": {
    ...
    description:
      "High sound-dampening commercial carpet tile installation for corporate offices and banks.",
    ...
    features: [
      "Noise Reduction Coefficient (NRC > 0.25)",
      "Modular Replacement",
    ],
  ...
  "artificial-grass": {
    ...
    description:
      "Turnkey synthetic grass installation for residential lawns, balcony gardens, and rooftop terraces.",
    ...
    features: [
      "Natural 4-Tone Spring Green Yarn Color",
      "10-Year UV Anti-Fading",
    ],
  ...
  "roller-blinds": {
    ...
    description:
      "Precision window measurement, headrail mounting, and motor automation for Roller blackout blinds in bedrooms, conference rooms, and offices.",
    ...
    features: [
      "100% Light Blocking Thermal Blackout Fabric",
      "Remote Control Motorized & Tuya Smart Sync",
    ],
    specifications: {
      "Service Type": "Window Measurement & Cassette Installation",
    },
  },
  ...
  "vertical-blinds": {
    ...
    description:
      "Ideal light management for floor-to-ceiling glass office facades and hospital ward windows with 180-degree rotation control.",
    ...
    features: [
      "180-Degree Rotation Slat Control",
      "Dust-Repellent Treated Polyester Louvers",
    ],
  ...
  "wooden-blinds": {
    ...
    description:
      "Genuine kiln-dried basswood horizontal slat Venetian blinds with woven cloth tape accents.",
    ...
    features: [
      "50mm Kiln-Dried Real Basswood Slats",
      "Woven Fabric Tape Cord Accents",
    ],
  ...
  "bamboo-chick-blinds": {
    ...
    description:
      "Eco-friendly natural bamboo chick roll-up blinds for veranda heat protection and rustic outdoor ambiance.",
    ...
    features: [
      "Weather-Resistant Varnished Bamboo Slats",
      "Natural Heat & Sun Insulation",
    ],
  ...
  "zebra-blinds": {
    ...
    description:
      "Popular dual-layer fabric zebra blinds offering seamless transition between sheer light diffusion and complete privacy.",
    ...
    features: [
      "Dual Layer Alternating Sheer & Opaque Stripes",
      "Enclosed Aluminum Cassette Headrail",
    ],
  ...
  "pvc-strip-curtains": {
    ...
    description:
      "Heavy duty clear transparent PVC strip curtain door installation for cold storage rooms, warehouses, restaurants, and cleanroom doorways.",
    ...
    features: [
      "100% Transparent Food-Grade PVC Material",
      "Thermal Temperature & Dust Fly Protection",
      "Stainless Steel Hook Track Mounting",
    ],
    specifications: {
      "Strip Thickness": "2.0mm / 3.0mm Ribbed & Flat Formats",
    },
  },
  ...
  "verman-blinds": {
    ...
    description:
      "Triple-cell fabric vanes suspended between double sheer layers for soft diffused ambient lighting in luxury formal lounges.",
    ...
    features: [
      "Floating Fabric Vane Angle Adjustment",
      "Soft UV Light Diffusion",
    ],
  ...
  "customise-printed-design-blind": {
    ...
    description:
      "Custom HD UV graphic printing on blackout roller blinds for corporate office branding and kids bedroom themes.",
    ...
    features: [
      "Non-Fading Eco UV HD Graphic Printing",
      "100% Custom Image/Logo Support",
    ],
  ...
  curtains: {
    ...
    description:
      "Tailored heavy blackout velvet and sheer linen curtains installed with concealed motorized ceiling track channels.",
    ...
    features: [
      "Concealed Electric Remote Track Systems",
      "Heavy Double Lining Thermal Insulation",
    ],
  ...
  "wallpaper-all-generation": {
    ...
    description:
      "Imported heavy-duty 3D textured wallpapers hung by expert master paper-hangers.",
    image: "/images/products/wallpaper-all-generation_1.webp",
    gallery: [
      "/images/products/wallpaper-all-generation_1.webp",
      "/images/products/wallpaper-all-generation_2.webp",
      "/images/products/wallpaper-all-generation_3.webp",
      "/images/products/wallpaper-all-generation_4.webp",
    ],
    targetSpaces: ["Master Bedrooms", "Drawing Room Features"],
    features: ["Heavy Washable Vinyl-Coated Wallpaper Rolls"],
    specifications: {
      "Roll Size": "1.06m x 15.6m (Korean Standard Jumbo Roll)",
    },
  },
  ...
  "customise-design-canvas": {
    ...
    description:
      "High-definition single-piece canvas wall murals printed to exact room dimensions with zero joints.",
    image: "/images/products/customise-design-canvas_1.webp",
    gallery: [
      "/images/products/customise-design-canvas_1.webp",
      "/images/products/customise-design-canvas_2.webp",
      "/images/products/customise-design-canvas_3.webp",
    ],
  ...
  "pvc-panel": {
    ...
    description:
      "Interlocking hollow-core PVC wall panels installed over damp, salt-affected brick walls.",
    image: "/images/products/pvc-panel_1.webp",
    gallery: [
      "/images/products/pvc-panel_1.webp",
      "/images/products/pvc-panel_2.webp",
      "/images/products/pvc-panel_3.webp",
      "/images/products/pvc-panel_4.webp",
    ],
  ...
  "fluted-panels": {
    ...
    description:
      "Modern architectural WPC fluted slat wall cladding with integrated warm LED strip channels.",
    image: "/images/products/fluted-panels_1.webp",
    gallery: [
      "/images/products/fluted-panels_1.webp",
      "/images/products/fluted-panels_2.webp",
      "/images/products/fluted-panels_3.webp",
    ],
  ...
  "wall-texture": {
    ...
    description:
      "Hand-troweled Italian Venetian plaster and velvet tactile wall texture finishes.",
    image: "/images/products/wall-texture_1.webp",
    gallery: [
      "/images/products/wall-texture_1.webp",
      "/images/products/wall-texture_2.webp",
      "/images/products/wall-texture_3.webp",
      "/images/products/wall-texture_4.webp",
    ],
  ...
  "wall-moulding": {
    ...
    description:
      "Precision mitered polyurethane wall panel mouldings, chair rails, and dado borders.",
    image: "/images/products/wall-moulding_1.webp",
    gallery: [
      "/images/products/wall-moulding_1.webp",
      "/images/products/wall-moulding_2.webp",
      "/images/products/wall-moulding_3.webp",
      "/images/products/wall-moulding_4.webp",
    ],
  ...
  "commercial-furniture": {
    ...
    description:
      "Custom bespoke manufacturing and installation of executive director desks and boardroom tables.",
    image: "/images/products/commercial-furniture_new_1.webp",
    gallery: ["/images/products/commercial-furniture_new_1.webp"],
  ...
  "residential-furniture": {
    ...
    description:
      "Bespoke handcrafted furniture for luxury bungalows and apartments.",
  ...
  kitchen: {
    ...
    description:
      "Bespoke modular kitchen manufacturing and site fitting. High-gloss acrylic shutters and Blum soft-close hardware.",
  ...
  "false-ceiling": {
    ...
    description:
      "Complete ceiling renovation using moisture-resistant Elephant Gypsum boards and metal studs.",
    image: "/images/products/false-ceiling_1.webp",
    gallery: [
      "/images/products/false-ceiling_1.webp",
      "/images/products/false-ceiling_2.webp",
      "/images/products/false-ceiling_3.webp",
    ],
  ...
  "fiber-shades": {
    ...
    description:
      "Fabrication and installation of UV-resistant fiber glass car parking canopies.",
    image: "/images/products/fiber-shades_1.webp",
    gallery: [
      "/images/products/fiber-shades_1.webp",
      "/images/products/fiber-shades_2.webp",
      "/images/products/fiber-shades_3.webp",
      "/images/products/fiber-shades_4.webp",
    ],
...
export const PROJECTS_DATA = [
  {
    ...
    image: "/images/products/project1.jpeg",
    year: "2026",
  },
  {
    id: "bahadurabad-kitchen",
    title: "HDF Kitchen Cabinets",
    category: "Kitchen",
    location: "Bahadurabad, Karachi",
    scope: "40mm thick HDF Boards with guarantee",
    image: "/images/products/project2.jpeg",
    year: "2025",
  },
  {
    ...
    image: "/images/products/project3.jpeg",
    year: "2025",
  },
  {
