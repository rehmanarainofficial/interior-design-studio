...
export default function CalculatorPage({ onOpenQuote }) {
  return (
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="text-center max-w-3xl mx-auto space-y-3">
          ...
          <h1 className="font-heading text-3xl sm:text-5xl font-extrabold text-[#FFF0DC]">
            Flooring Sq Ft & Budget Estimator
          </h1>
          <p className="text-xs sm:text-sm text-gray-300">
            Compute your exact floor area, cutting wastage allowance, labor installation costs, and total PKR project budget.
          </p>
        </div>

        <FlooringCalculator onOpenQuote={onOpenQuote} />
      </div>
    </div>
  );
}
