...
import { 
  ...
  Home as HomeIcon, Dumbbell, Stethoscope, Send, MessageCircle, Clock, Mail, CheckCircle, ChevronLeft, ExternalLink,
  Ruler, PackageCheck, Hammer, Globe
} from 'lucide-react';
import { FITTING_CATEGORIES, SOLUTIONS_DATA, PROJECTS_DATA } from '../data/productsData';
import SEO from '../components/SEO';

// Hero background images mapping per property category
const HERO_BACKGROUNDS = {
  residential: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&q=80&w=2560',
  commercial: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=2560',
  hospitality: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&q=80&w=2560',
  retail: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&q=80&w=2560'
};
...
const ENHANCED_REVIEWS = [
  {
    ...
    quote: 'Interior Design Studio team installed SPC wood flooring in our entire bungalow (3,200 sq ft) in just 3 days! The finish is flawless, 100% waterproof, and their installation crew was extremely clean and professional.',
    rating: 5,
    verifiedLink: 'https://wa.me/923102321899?text=Hi%20Tariq%20Mansoor%20Reference%20Site%20DHA%20Karachi',
    date: 'Verified Site Execution • Feb 2026'
  },
  {
    name: 'Sameer Alvi',
    role: 'Director, Medicare Hospital Karachi',
    quote: 'They executed seamless antibacterial vinyl floor fitting with hot rod thermal seam welding in 4 Operating Theaters. Excellent work quality and completed strictly on schedule.',
    rating: 5,
    verifiedLink: 'https://wa.me/923102321899?text=Hi%20Medicare%20Hospital%20Karachi%20Project%20Reference',
    date: 'Verified Commercial Project • Jan 2026'
  },
  {
    name: 'Ayesha Shah',
    role: 'Principal Architect, Gulberg Lahore',
    quote: 'My preferred turnkey contractor in Pakistan for office acoustic carpet tiles, gym rubber floors, and fluted WPC wall slats. Highly recommended for site execution.',
    rating: 5,
    verifiedLink: 'https://wa.me/923102321899?text=Hi%20Ayesha%20Shah%20Architect%20Reference',
    date: 'Verified Architect Review • Feb 2026'
  },
  {
    name: 'Hamza Khan',
    role: 'Fitness Director, Apex Gym F-7 Islamabad',
    quote: 'We ordered 20mm heavy shock-absorbing rubber tiles for our free weight area. Barbell drops are dead quiet now and no subfloor cracking. Outstanding fitting work!',
    rating: 5,
    verifiedLink: 'https://wa.me/923102321899?text=Hi%20Apex%20Gym%20Islamabad%20Project%20Reference',
...
export default function Home({ onOpenQuote }) {
  ...
  const prevReview = () => {
    setCurrentReviewIndex((prev) => (prev - 1 + ENHANCED_REVIEWS.length) % ENHANCED_REVIEWS.length);
  };
      ...
      <section className="relative min-h-[92vh] flex flex-col justify-between overflow-hidden pt-28 pb-12 px-4 sm:px-6 lg:px-8 bg-[#111111] border-b border-[#C19A5B]/30">
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full text-left space-y-8 animate-fade-in my-auto">
          ...
          <h1 className="font-heading font-medium text-4xl sm:text-6xl lg:text-7xl text-white leading-[1.1] tracking-tight max-w-4xl">
            ...
            <span className="italic font-normal text-[#FFF0DC]">Experiences</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-2.5 pt-2">
            ...
            <button
              onClick={() => setHeroCategory('retail')}
              className={`px-4 py-2 rounded-full text-xs font-semibold transition-all ${
                heroCategory === 'retail'
                  ? 'bg-white text-[#111111] shadow-lg scale-105 font-bold'
                  : 'bg-black/40 backdrop-blur-md text-gray-200 border border-white/20 hover:bg-white/20'
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full pt-12 border-t border-white/15">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center md:text-left">
            <div>
              ...
              <span className="text-[10px] sm:text-xs text-gray-300 font-bold uppercase tracking-widest mt-1 block">Projects Completed</span>
            </div>
            <div>
              <span className="font-heading text-3xl sm:text-5xl font-semibold text-[#C19A5B] block transition-all">
                {counts.years}+
              </span>
              <span className="text-[10px] sm:text-xs text-gray-300 font-bold uppercase tracking-widest mt-1 block">Years Experience</span>
            </div>
            <div>
              <span className="font-heading text-3xl sm:text-5xl font-semibold text-[#C19A5B] block transition-all">
                {counts.awards}
              </span>
              <span className="text-[10px] sm:text-xs text-gray-300 font-bold uppercase tracking-widest mt-1 block">Design Awards</span>
            </div>
            <div>
              <span className="font-heading text-3xl sm:text-5xl font-semibold text-[#C19A5B] block transition-all">
                {counts.satisfaction}%
              </span>
              <span className="text-[10px] sm:text-xs text-gray-300 font-bold uppercase tracking-widest mt-1 block">Client Satisfaction</span>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="bg-[#262628] text-white p-8 rounded-3xl border border-[#C19A5B]/30 shadow-xl space-y-3">
              <span className="font-heading font-semibold text-4xl sm:text-5xl text-[#C19A5B] block">7+ Years</span>
              <h3 className="font-sans-heading font-bold text-lg text-white">Site Fitting Experience</h3>
              <p className="text-xs sm:text-sm text-gray-300 font-normal">Master craftsmen specializing in flooring, wall cladding, and motorized window blinds.</p>
            </div>

            <div className="bg-[#262628] text-white p-8 rounded-3xl border border-[#C19A5B]/30 shadow-xl space-y-3">
              <span className="font-heading font-semibold text-4xl sm:text-5xl text-[#C19A5B] block">500+</span>
              <h3 className="font-sans-heading font-bold text-lg text-white">Completed Projects</h3>
              <p className="text-xs sm:text-sm text-gray-300 font-normal">Delivered bungalows, corporate office floors, commercial gyms, and hospital OT rooms in Karachi.</p>
            </div>

            <div className="bg-[#262628] text-white p-8 rounded-3xl border border-[#C19A5B]/30 shadow-xl space-y-3">
              <span className="font-heading font-semibold text-4xl sm:text-5xl text-[#C19A5B] block">20-Year</span>
              <h3 className="font-sans-heading font-bold text-lg text-white">Material & Fitting Warranty</h3>
              <p className="text-xs sm:text-sm text-gray-300 font-normal">100% Water, Termite, and Workmanship protection guarantee on all installed SPC and Vinyl floors.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
            <div className="flex items-center space-x-4 bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
              ...
              <div>
                <strong className="text-sm text-[#111111] font-bold block">100% Water & Termite Guarantee</strong>
                <span className="text-xs text-gray-600 font-normal">Specially engineered for Pakistani climate and humidity.</span>
              </div>
            </div>
            <div className="flex items-center space-x-4 bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
              <Award className="w-8 h-8 text-[#C19A5B] shrink-0" />
              <div>
                <strong className="text-sm text-[#111111] font-bold block">Laser Site Measurement</strong>
                <span className="text-xs text-gray-600 font-normal">Accurate laser site survey and zero material wastage calculation.</span>
              </div>
            </div>
            <div className="flex items-center space-x-4 bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
              <CheckCircle2 className="w-8 h-8 text-[#C19A5B] shrink-0" />
              <div>
                <strong className="text-sm text-[#111111] font-bold block">Nationwide Fitting Crews</strong>
                <span className="text-xs text-gray-600 font-normal">On-site execution in Karachi, Lahore, Islamabad & Rawalpindi.</span>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-10">
          ...
          <p className="text-sm text-gray-600">
            Hover over any solution image to view installation details and material specs.
          </p>
        ...
        {selectedCategory.items.length > 6 && (
          <div className="text-center pt-10">
            <button 
              onClick={() => handleLinkClick(`/category/${selectedCategory.id}`)}
              className="btn-gold px-8 py-3.5 rounded-xl text-xs sm:text-sm font-semibold inline-flex items-center space-x-2 shadow-lg"
            >
              <span>View All {selectedCategory.name} Solutions ({selectedCategory.items.length})</span>
              <ArrowRight className="w-4 h-4 text-white" />
            </button>
          </div>
        )}
        ...
        <div className="max-w-6xl mx-auto space-y-16 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-3">
            ...
            <p className="text-sm sm:text-base text-gray-300 font-normal leading-relaxed">
              A collaborative four-step journey from initial vision to final reveal, ensuring every detail reflects your unique story.
            </p>
          </div>
        ...
        <div className="bg-[#262628] text-white p-8 sm:p-12 rounded-3xl border border-[#C19A5B]/30 shadow-2xl space-y-6 relative">
          <div className="flex items-center justify-between">
            <div className="flex text-[#C19A5B] space-x-1">
              {[...Array(ENHANCED_REVIEWS[currentReviewIndex].rating)].map((_, i) => (
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-3">
            ...
            <p className="text-xs sm:text-sm text-gray-600">
              Reach out to our senior contracting team for site measurements, sample books, or custom site estimates.
            </p>
          </div>
              ...
              <div className="space-y-4 text-xs sm:text-sm">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <span className="text-gray-300">Shop No 132, Shamim Sky Tower, Federal B Area Block 9 Yaseenabad, Karachi, Pakistan.</span>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <strong className="text-white block font-bold">Call / WhatsApp:</strong>
                    <a href="tel:03102321899" className="text-[#C19A5B] hover:underline font-bold text-sm sm:text-base">0310 2321899</a>
                  </div>
                </div>
            ...
            <div className="lg:col-span-7 bg-white p-8 rounded-3xl border border-gray-200 shadow-sm space-y-6">
              ...
              {contactSubmitted ? (
                <div className="p-8 text-center space-y-3 bg-[#FFF0DC] rounded-2xl border border-[#C19A5B]/30">
                  ...
                  <h4 className="font-sans-heading text-lg font-bold text-[#111111]">Inquiry Sent Successfully!</h4>
                  <p className="text-xs text-gray-700">Thank you! Our senior contractor will call you back within 1 hour.</p>
                </div>
              ) : (
                <form onSubmit={handleContactSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-xs font-bold text-[#111111] mb-1">Solution Category *</label>
                  ...
                  <div>
                    <label className="block text-xs font-bold text-[#111111] mb-1">Message / Requirements</label>
                    <textarea 
                      rows="3" 
